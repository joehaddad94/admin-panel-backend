...
export class MicrocampApplicationFactory {
  static createMockMicrocampApplication(overrides: Partial<MicrocampApplication> = {}): MicrocampApplication {
    const defaultApplication: MicrocampApplication = {
      id: 1,
  ...
  static createMockMicrocampApplicationList(count: number, overrides: Partial<MicrocampApplication> = {}): MicrocampApplication[] {
  ...
  static createMockMicrocampApplicationWithRelations(overrides: Partial<MicrocampApplication> = {}): MicrocampApplication {
  ...
  static createMockMicrocampApplicationForCreate(overrides: Partial<MicrocampApplication> = {}): Partial<MicrocampApplication> {
    return {
  ...
  static createMockMicrocampApplicationForUpdate(overrides: Partial<MicrocampApplication> = {}): Partial<MicrocampApplication> {
    return {
  ...
  static createMockMicrocampApplicationWithDifferentAgeRanges(): MicrocampApplication[] {
  ...
  static createMockMicrocampApplicationWithDifferentCountries(): MicrocampApplication[] {
  ...
  static createMockMicrocampApplicationWithDifferentReferralSources(): MicrocampApplication[] {
    const sources = ['Social Media', 'Website', 'Email', 'Friend', 'Advertisement', 'Search Engine'];
