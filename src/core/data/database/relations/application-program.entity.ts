...
import { Application } from '../entities/application.entity';  // Update these imports based on your actual file structure
...
export class ApplicationProgram extends BaseEntity {
    ...
    @ManyToOne(() => Program, program => program.applicationProgram, { eager: true })
